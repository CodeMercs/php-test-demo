...
CREATE TABLE `student` (
  ...
  `dep` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(200) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

INSERT INTO `student` (`sid`, `birthday`, `dep`, `name`) VALUES
(1, '19930929', 'Engineering', 'Kan'),
(2, '19930928', 'Law', 'Jun'),
(3, '19930927', 'Engineering', 'Jeff'),
(4, '19930926', 'Law', 'Hao'),
(5, '19930925', 'Math', 'Cheng');
